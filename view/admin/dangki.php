...
{
    return '<th>Id</th><th>Tiêu đề</th><th>Tên</th><th>Điện Thoại</th><th>Email</th><th>Region</th><th>Created</th>';
}
//
...
function showFrom($form,$ListKey=array())
{
    ...
    $str_from.='<p><label>Region</label><input class="text-input small-input" type="text"  name="Region" value="'.(($form!=false)?$form->Region:'').'" /></p>';
